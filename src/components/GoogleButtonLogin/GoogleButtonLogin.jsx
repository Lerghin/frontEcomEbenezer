...
import '../GoogleButtonLogin/googleButton.css'
import axios from 'axios'

const GoogleButtonLogin = ({fn}) => {
  ...
  return (
    <div onClick={()=>login()} id="google" className="w-3/12 max-w-full px-1 mr-auto flex-0">
    <a >
